...
class SignalHandler(core.QObject):
    ...
    def activate(self):
        ...
        if utils.is_posix and hasattr(signal, 'set_wakeup_fd'):
            ...
            self._notifier = core.QSocketNotifier(
                cast(sip.voidptr, read_fd), core.QSocketNotifier.Type.Read, self
            )
...
def init(
    q_app: widgets.QApplication, args: argparse.Namespace, quitter: 'quitter.Quitter'
) -> None:

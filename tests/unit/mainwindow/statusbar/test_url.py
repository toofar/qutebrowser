...
@pytest.mark.parametrize(
    ...
    [
        ...
        (usertypes.LoadStatus.success, core.QUrl('http://reddit.com/r/linux')),
        (usertypes.LoadStatus.success, core.QUrl('http://ä.com/')),
        (usertypes.LoadStatus.success_https, core.QUrl('www.google.com')),
        (
        ...
        (usertypes.LoadStatus.error, core.QUrl('invalid::/url')),
        (usertypes.LoadStatus.error, core.QUrl()),
    ],
)

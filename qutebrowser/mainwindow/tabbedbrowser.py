...
class TabDeque:
    ...
    def __init__(self) -> None:
        ...
        if size < 0:
            size = None
        self._stack: Deque[weakref.ReferenceType[widgets.QWidget]] = collections.deque(
            maxlen=size)
        # Items that have been removed from the primary stack.
        self._stack_deleted: List[weakref.ReferenceType[widgets.QWidget]] = []
        self._ignore_next = False
        self._keep_deleted_next = False

    def on_switch(self, old_tab: widgets.QWidget) -> None:
    ...
    def prev(self, cur_tab: widgets.QWidget) -> widgets.QWidget:
        """Get the 'previous' tab in the stack.

        Throws IndexError on failure.
        """
        tab: Optional[widgets.QWidget] = None
    ...
    def last(self, cur_tab: widgets.QWidget) -> widgets.QWidget:
        """Get the last tab.
...
class TabbedBrowser(widgets.QWidget):
    ...
    def __init__(self, *, win_id, private, parent=None):
        ...
        self._local_marks: MutableMapping[core.QUrl, MutableMapping[str, int]] = {}
        self._global_marks: MutableMapping[str, Tuple[int, core.QUrl]] = {}

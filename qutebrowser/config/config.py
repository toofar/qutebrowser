...
class Config(core.QObject):
    ...
    def __init__(
        self, yaml_config: 'configfiles.YamlConfig', parent: core.QObject = None
    ) -> None:
    ...
    def get(self, name: str, url: core.QUrl = None, *, fallback: bool = True) -> Any:
    ...
    def get_obj(
        self, name: str, *, url: core.QUrl = None, fallback: bool = True
    ) -> Any:

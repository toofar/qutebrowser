...
class TestSpecialMethods:
    ...
    def test_contains(self, web_history):
        web_history.add_url(
            core.QUrl('http://www.example.com/'), title='Title', atime=12345
        )
...
class TestAdd:
    ...
    def test_add_url(
        ...
        web_history.add_url(core.QUrl(url), atime=atime, title=title, redirect=redirect)
    ...
    def test_no_sql_web_history(self, web_history, monkeypatch):
        ...
        web_history.add_url(
            core.QUrl('https://www.example.com/'),
            atime=12346,
            title='Hello World',
            redirect=False,
        )
...
class TestHistoryInterface:
    ...
    def hist_interface(self, web_history):
        ...
        web_history.add_url(url=core.QUrl('http://www.example.com/'), title='example')
...
class TestDump:
    ...
    def test_debug_dump_history(self, web_history, tmpdir):
        web_history.add_url(
            core.QUrl('http://example.com/1'), title="Title1", atime=12345
        )
        web_history.add_url(
            core.QUrl('http://example.com/2'), title="Title2", atime=12346
        )
        web_history.add_url(
            core.QUrl('http://example.com/3'), title="Title3", atime=12347
        )
        web_history.add_url(
            core.QUrl('http://example.com/4'),
            title="Title4",
            atime=12348,
            redirect=True,
        )
...
class TestRebuild:
    ...
    def test_exclude(self, config_stub, web_history, stubs):
        ...
        web_history.add_url(core.QUrl('http://example.com'), redirect=False, atime=1)
        web_history.add_url(core.QUrl('http://example.org'), redirect=False, atime=2)
